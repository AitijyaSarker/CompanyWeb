...
export function WhyChooseUsSection() {
  ...
  return (
    <section
      ref={ref}
      id="why-choose-us"
      className="relative overflow-hidden py-20 sm:py-28 lg:py-32 bg-white dark:bg-slate-950/60 text-foreground transition-colors duration-300"
    >
      <div className="site-container relative">
        ...
        >
          ...
          <motion.div
            ...
            className="group relative flex flex-col justify-between rounded-3xl border border-slate-200/90 bg-slate-50/90 p-8 shadow-sm backdrop-blur-xl transition-all duration-300 hover:border-cyan-500/50 hover:shadow-lg md:col-span-3 lg:col-span-7 dark:border-white/10 dark:bg-slate-900/70 dark:hover:shadow-[0_20px_50px_rgba(6,182,212,0.12)]"
          >
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3 py-1 text-xs font-bold text-cyan-700 dark:text-cyan-400">
                  Top 3% Talent
                </span>
              </div>
            ...
            <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 gap-4 pt-6 border-t border-slate-200/80 dark:border-white/10 text-xs">
              <div>
          ...
          <motion.div
            variants={fadeUpSpring}
            className="group relative flex flex-col justify-between rounded-3xl border border-slate-200/90 bg-slate-50/90 p-8 shadow-sm backdrop-blur-xl transition-all duration-300 hover:border-cyan-500/50 hover:shadow-lg md:col-span-3 lg:col-span-5 dark:border-white/10 dark:bg-slate-900/70 dark:hover:shadow-[0_20px_50px_rgba(6,182,212,0.12)]"
          >
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="rounded-full border border-blue-500/30 bg-blue-500/10 px-3 py-1 text-xs font-bold text-blue-700 dark:text-blue-400">
                  SecOps Certified
                </span>
              </div>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white">
            ...
            <div className="mt-6 pt-5 border-t border-slate-200/80 dark:border-white/10 space-y-2 text-xs text-slate-700 dark:text-slate-300">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="size-4 text-cyan-600 dark:text-cyan-500 shrink-0" />
          ...
          >
            ...
            <div className="mt-6 font-mono text-xs text-amber-700 dark:text-amber-400 font-semibold">
          ...
          >
            ...
            <div className="mt-6 font-mono text-xs text-emerald-700 dark:text-emerald-400 font-semibold">
          ...
          >
            ...
            <div className="mt-6 font-mono text-xs text-indigo-700 dark:text-indigo-400 font-semibold">
              // Zero Vendor Lock-in
            </div>
          </motion.div>
        </motion.div>
